...
jQuery(function ($) {
    ...
    */
    var App = {
        ...
        $counterCapMax: $('#counter-cap-max'),
        $counterInternacoes: $('#counter-internacoes'),
        $counterRepublica: $('#counter-republica'),
        ...
        docReady: function () {
            ...
            this.$counterInternacoes.counterUp({
                delay: 50,
                time: 6000
            });

            this.$counterCapMax.counterUp({
                delay: 50,
                time: 6000
            });

            this.$counterRepublica.counterUp({
                delay: 50,
                time: 6000
            });
